...
#define pulseiraE 9
#define pulseiraD 11
#define ledAux 13 // ao piscar mostra que o giroscopio está calibrado
...
void setup() {
  ...
  digitalWrite(pulseiraE, HIGH);
  digitalWrite(pulseiraD, HIGH);
  delay(300);
  digitalWrite(pulseiraE, LOW);
  digitalWrite(pulseiraD, LOW);
  delay(300);
  digitalWrite(pulseiraE, HIGH);
  digitalWrite(pulseiraD, HIGH);
  delay(300);
...
void loop() {
  ...
  mediaSensor= (cm1+cm3)/2.0; // Retiranos o sensor 2 que não funciona corretamente
